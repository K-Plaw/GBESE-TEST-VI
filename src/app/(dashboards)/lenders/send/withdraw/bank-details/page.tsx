...
export default function BankDetails() {
  ...
  const handleNext = () => {
    if (accountNumber.length === 10) {
      router.push('/lenders/send/withdraw/confirm');
    }
  };
  ...
  return (
    <div className="flex justify-center items-center px-4 md:px-0 py-12">
      <div className="w-full max-w-md border rounded-md bg-white shadow-sm p-6 md:p-10">
        ...
        {/* Back Link */}
        <Link href="/lenders/send/withdraw/add-bank" className="flex items-center text-sm text-gray-600 mb-4 hover:underline">
        ...
        <div className="flex items-center justify-between border rounded-md px-4 py-3 mb-6">
          ...
          <Link href="/lenders/send/withdraw/add-bank">
            <Image
