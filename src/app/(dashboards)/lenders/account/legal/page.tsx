  ...
  const legalItems = [
    {
      ...
      href: '/lenders/account/legal/terms',
    },
    {
      title: 'Policies',
      href: '/lenders/account/legal/policies',
    },
    {
      title: 'Disclaimer',
      href: '/lenders/account/legal/disclaimer',
    },
  ]

  return (
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
      <Link href="/lenders/account" className="flex items-center text-sm text-muted-foreground hover:underline w-fit">
