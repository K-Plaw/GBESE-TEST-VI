  ...
  const tabs = [
    {
      ...
      href: '/lenders/account/security/pin',
      icon: '/securities.svg', // Update with your actual path
    },
    {
      title: 'Two Factor Authentication',
      href: '/lenders/account/security/two-factor',
      icon: '/securities.svg',
    },
    {
      title: 'KYC',
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-[#2C2C2C]">
      <div className="max-w-3xl mx-auto px-4 pt-6">
        {/* Back Navigation */}
        <div className="mb-6">
          <Link href="/lenders/account" className="flex items-center text-sm text-[#2C2C2C] hover:underline">
