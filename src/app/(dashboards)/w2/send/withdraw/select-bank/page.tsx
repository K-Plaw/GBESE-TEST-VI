  ...
  return (
    <div className="flex justify-center items-center min-h-screen px-4">
      <div className="w-full max-w-md border rounded-md bg-white shadow-sm py-8 px-6">
        {/* Back Link */}
        <Link href="/w2/send/withdraw" className="flex items-center text-sm text-gray-500 hover:text-gray-700 mb-4">
        ...
        <Link
          href="/w2/send/withdraw/add-bank"
        ...
        <div className="bg-white border rounded-xl p-4 mt-6 shadow-sm">
          {banks.map((bank, idx) => (
            <Link
              href="/w2/send/withdraw/review-details"
              key={idx}
